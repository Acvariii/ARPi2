...
class PopupDrawer:
    ...
    def draw_buy_prompt(self, popup_data: Dict, panel, buttons: list):
        ...
        RotatedText.draw_block(
            ...
            pygame.Rect(content_rect.x, name_y, content_rect.width, name_h),
            panel.orientation,
            line_spacing=4,
            wrap=True
        )
    ...
    def draw_card_popup(self, popup_data: Dict, panel, buttons: list):
        ...
        RotatedText.draw_block(
            ...
            pygame.Rect(content_rect.x, title_y, content_rect.width, title_h),
            panel.orientation,
            line_spacing=4
        )
    ...
    def draw_properties_popup(self, popup_data: Dict, panel, properties, property_scroll: int, buttons: list):
        ...
        if not player.properties:
            ...
            RotatedText.draw_block(
                ...
                pygame.Rect(content_rect.x, page_y, content_rect.width, 18),
                panel.orientation,
                line_spacing=4
            )
