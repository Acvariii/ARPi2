...
class MonopolyGame:
    ...
    def _draw_buy_prompt(self):
        ...
        # Content positioning (vertical spacing)
    ...
    def _draw_card_popup(self):
        ...
        # Get content area (consistent for all orientations)
        if panel.is_vertical():
            content_rect = panel.get_grid_rect(0.3, 1.5, 1.4, 6, 4, 12)
        else:
            content_rect = panel.get_grid_rect(1, 0.5, 7, 2.8, 12, 4)
        ...
        # Card text area - inflate to give padding
    ...
    def _draw_properties_popup(self):
        ...
        if not player.properties:
            ...
            # Property details - simple centered list
            y_offset = name_y + 40
            line_spacing = 25
